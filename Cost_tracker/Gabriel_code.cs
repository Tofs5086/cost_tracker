...
namespace AzureCostTracker
{
    class Program
    {
        ...
        private static string clientId = "d6dac08d-7f97-419a-a371-f4f9b1984375";
        private static string tenantId = "38659c2b-60ae-4fb6-a2a1-b9ef48bad094";
        private static string subscriptionId = "32d312d6-aa4b-4a39-a257-4e9c526084b3";
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                await SendEmailAsync(
                    ...
                    ccEmails: new[] { "usen_aizenosa@yahoo.com", "sundinoh@gmail.com" }, // Team emails
        ...
        private static async Task SendEmailAsync(string toEmail, string[] ccEmails, string subject, string body)
        {
            ...
            { 
                ...
                // Gmail SMTP settings
                const string fromPassword = "okix cbsl yzui zcje"; // Gmail APP password
